...
This guide reflects how we build studies at the [Center for Healthy Minds](https://centerhealthyminds.org). It's primarily for internal CHM researchers, but it's on the web for anyone. You may disagree with some of the choices we've made, but if you take one thing from this guide: **Choose a consistent style and use it as much as you can in your own project.**

The more consistent you are within your project, the less you'll need to refer to your codebooks, look up variable names, and the fewer logic errors you'll make. The more consistent you are, the easier time participants will have in understanding 

This guide owes a great deal, both in structure and its opinionated nature, to the excellent [Tidyverse style guide](https://style.tidyverse.org).
