...
This guide reflects how we build studies at the [Center for Healthy Minds](https://centerhealthyminds.org). It's primarily for internal CHM researchers, but everyone is free to use it. You may disagree with some of the choices we've made (style guides are, after all, opinionated!), but if you take one thing from this guide: **Choose a consistent style and use it as much as you can in your own project.**
